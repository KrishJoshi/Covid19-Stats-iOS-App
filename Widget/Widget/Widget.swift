...
struct DataProvider : IntentTimelineProvider {
    ...
    func placeholder(in context: Context) -> CoronaData {
        return CoronaData(Corona(Global: Global(NewConfirmed: 0, TotalConfirmed: 0, NewDeaths: 0, TotalDeaths: 0, NewRecovered: 0, TotalRecovered: 0), Countries: [Countries(Country: "United Kingdom", CountryCode: "UK", Slug: "uk", NewConfirmed: 0, TotalConfirmed: 0, NewDeaths: 0, TotalDeaths: 0, NewRecovered: 0, TotalRecovered: 0, Date: "DATE")]))
    }
